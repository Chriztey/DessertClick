...
@Composable
private fun DessertClickerAppScreen(
    ...
    DessertClickerApp(
        ...
        onButtonClicked = { dessertViewModel.onDessertClicked() }
    )
}
...
private fun DessertClickerApp(
    ...
    Scaffold(
            ...
            DessertClickerAppBar(
                onShareButtonClicked = {
                    shareSoldDessertsInformation(
                        ...
                        revenue = dessertUiState.totalProfit
                    )
                },
                modifier = Modifier
                    .fillMaxWidth()
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = onButtonClicked,
